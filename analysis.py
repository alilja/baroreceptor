...
class FindSBRP:
    ...
    def find_matches(self, SBP, RR, clusterWidth = 3, lag = 0):
        if(_verbose):
...
def main():
    ...
    matchingRuns = sbrp.find_matches(data[0],data[1], _width, _lag)
    print("Found %s matching, non-correlated runs." % len(matchingRuns))

    # Correlate
    print("Calculating correlation...")
    correlatedRuns = sbrp.correlate_runs(matchingRuns, _pearson)
